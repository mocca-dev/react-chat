...
<br>
<p>
  This is a simple chat app where you sign in and simply chat with the rest of the chat room. Here I tried to practice react hooks and the communication with Firebase using <strong>react-firebase-hooks</strong>.
</p>
...
It's very straightfoward, just sign in and start chating.
...
Project Link: [https://github.com/mocca-dev/react-chat.git](https://github.com/mocca-dev/react-chat.git)
